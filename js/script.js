...
const product1=new products('Watch','80 $','accessories','Images/61JuJlUvsUL._AC_SX679_.jpg',1);

const product2=new products('Watch','80 $','accessories','Images/71jyJGd2lfL._AC_SY741_.jpg',1);

const product3=new products('earpods','200 $','Phone accessories ','Images/WhatsApp Image 2024-02-04 at 7.38.30 PM.jpeg',2);

const product4=new products('earpods','200 $','Phone accessories ','Images/harry-pappas-26jZFPgpAl0-unsplash.jpg',2);



const product5=new products('Phones','80 $','Phones','Images//aram-sabah-smVUoz8CSCw-unsplash.jpg',5);


const product6=new products('Laptop','20 $','Electronic Device','Images//kari-shea-k09UjFzAFbE-unsplash.jpg',6);

const product7=new products('Phones','80 $','Phones','Images///paolo-giubilato-ZwKCWVFdrcs-unsplash.jpg',5);



const product8=new products('Play station','80 $','Games','Images/nik-ads33nL7V4k-unsplash.jpg',8);


const product9=new products('Play station','80 $','Games','Images//martin-katler-caNzzoxls8Q-unsplash.jpg',9);
